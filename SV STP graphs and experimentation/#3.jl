                ...
                if spiked[cc] #spike occurred
                    ...
                    elseif (Ne+Np) < cc <= (Np+Ne+Ns)
                        ...
                        if(cc ∈ range_plast_sst)
                            ...
                            @views Is[(1+Ne+Np+Ns):Ncells] .+= weights[cc, (1+Ne+Np+Ns):Ncells] / tausdecay .* u_SV[(1+Ne+Np+Ns):Ncells]
                            facilitation_spike[cc] = U_f*(U_max - u_SV[cc])
                        end
